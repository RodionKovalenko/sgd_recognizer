...
saved_model_path = '..\\..\\evaluation\\sbert_finetuned'
#bert model to create sentence representations
word_embedding_model = models.Transformer('Rodion/sbert_uno_sustainable_development_goals')
...
score = evaluator(model, output_path=saved_model_path, epoch=0, steps=0)
